...
class SimpleLocationsAPITests(TestCase):
    def setUp(self):
        ...
        self.area_children_compressed_url = reverse(
            "api-1.0.0:area_children_compressed", kwargs={"area_id": a.id, "simplify": 3, "quantize": 3}
        )
        self.area_type_compressed_url = reverse(
            "api-1.0.0:area_type_compressed", kwargs={"area_type": a.kind.slug, "simplify": 3, "quantize": 3}
        )
