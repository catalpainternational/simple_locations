...
This is the **4.0.x** maintenance line (pydantic 1 / django-ninja 0.x / psycopg2).
Dev and tests target **Django 4.2** on **Python 3.9+**. The pydantic-2 / Django-5.2
line lives on `dev` (4.2.x) — see the compatibility matrix above.
