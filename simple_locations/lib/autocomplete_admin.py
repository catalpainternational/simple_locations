...
class FkSearchInput(ForeignKeyRawIdWidget):
    ...
    class Media:
        css = {
            'all': ('/static/autocomplete/css/jquery.autocomplete.css',)
        }
        js = (
            '/static/autocomplete/js/jquery.js',
            '/static/autocomplete/js/jquery.bgiframe.min.js',
            '/static/autocomplete/js/jquery.ajaxQueue.js',
            '/static/autocomplete/js/jquery.autocomplete.js',
        )
...
class NoLookupsForeignKeySearchInput(ForeignKeyRawIdWidget):
    ...
    class Media:
        css = {
            'all': ('/site-media/autocomplete/css/jquery.autocomplete.css',)
        }
        js = (
            '/site-media/autocomplete/js/jquery.js',
            '/site-media/autocomplete/js/jquery.bgiframe.min.js',
            '/site-media/autocomplete/js/jquery.ajaxQueue.js',
            '/site-media/autocomplete/js/jquery.autocomplete.js',
        )
...
class FkAutocompleteAdmin(admin.ModelAdmin):
    ...
    def get_help_text(self, field_name, model_name):
        ...
        if searchable_fields:
            ...
            return _('Use the left field to do %(model_name)s lookups in the fields %(field_list)s. Use the right to enter registration number') % help_kwargs
        return ''
